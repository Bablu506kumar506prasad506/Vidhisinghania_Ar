...
/*
 * Check for 'Unapproved projects' section feature functionality in Chairperson dashboard
 */
public class TS_120 {
	...
	public void CRe4_519_520_521_522_523_524_525_526_527_528_529_530_531_532() throws Exception {
		...
		String Full_Board_Review = r1.getCell(2, 29).getContents();
		String Expedited_Review = r1.getCell(3, 29).getContents();
		String Exemption_Review = r1.getCell(4, 29).getContents();
		String Queries_Replied = r1.getCell(5, 29).getContents();
		String Projects_Withdrawn = r1.getCell(6, 29).getContents();
		String Projects_with_Queries = r1.getCell(7, 29).getContents();
		String Resubmission = r1.getCell(8, 29).getContents();

		String Unapproved_Projects = r1.getCell(9, 29).getContents();
		String Ongoing_Projects = r1.getCell(10, 29).getContents();
		String Upcoming_Meetings = r1.getCell(11, 29).getContents();
		String Announcements = r1.getCell(12, 29).getContents();
		String IEC_Submissions_Annexures = r1.getCell(13, 29).getContents();
		...
		ns.EXPWITHPROJMSTOCP();
		GlobalMethods.CPLogin();

		// ---TAKE COUNT AFTER FROM PROJECTS WITHDRAWN---//

		WebElement countbefore4 = GWait.Wait_GetElementByXpath("//li[5]/a/span[2]");
