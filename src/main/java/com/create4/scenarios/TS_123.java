...
/*
 * Check for 'Announcement' section feature functionality in Chairperson dashboard
 */
public class TS_123 {
	public TS_123() {
		// this.driver=driver;
...
GlobalWait GWait = new GlobalWait(GlobalMethods.driver);
	...
	WebElement addannouncementlink;
	
	@FindBy(id = "add_announcement_title")
	WebElement addannouncementtitle;
	
	@FindBy(id = "add_announcement_description")
	WebElement addannouncementdesc;
	
	@FindBy(id = "add_announcement_notification_date")
	WebElement addannouncementnotif;
	
	@FindBy(id = "add_announcement_notification_details")
	WebElement addannouncementbutton;
	
	@FindBy(css = "ul.submitions-list.list > li > a > span")
	WebElement announcementdashlink;
