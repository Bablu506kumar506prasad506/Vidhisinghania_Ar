...
//Check for amendment 'Document status' until MS decision in PI
public class TS_82 {
	...
	// Check for 'Document status' when Amendment submitted to IEC
	
	public void CRe4_1302_05_07_09() throws Exception {
		...
		String Decision_LOP = r1.getCell(26, 223).getContents();
		String Decisionfile = r1.getCell(27, 223).getContents();
		String Decisioncmnt = r1.getCell(28, 223).getContents();
		

		// Document upload data
		String Document_Title_in_list = r1.getCell(7, 223).getContents();
		String Version_in_list = r1.getCell(8, 223).getContents();
		String Document_Date_in_list = r1.getCell(9, 223).getContents();
		String doc_upload = r1.getCell(10, 223).getContents();
