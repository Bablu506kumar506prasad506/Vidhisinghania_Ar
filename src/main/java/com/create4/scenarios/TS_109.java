...
public class TS_109 {
	...
	public void CRe4_414_415_416_417_418_419_420_421_422_423_424_425_426_427_428_429() throws Exception {
		...
		String Unapproved_Projects = r1.getCell(0, 121).getContents();
		String Ongoing_Projects = r1.getCell(1, 121).getContents();
		String Reminders = r1.getCell(2, 121).getContents();
		String Upcoming_Meetings = r1.getCell(3, 121).getContents();
		String Investigator_Registration_Requests = r1.getCell(4, 121).getContents();
		String Study_Team_Member_Registration_Requests = r1.getCell(5, 121).getContents();
		String Announcements = r1.getCell(6, 121).getContents();

		String New_Submissions = r1.getCell(0, 122).getContents();
		String Resubmission = r1.getCell(0, 123).getContents();
		String Withdrawn_Requested = r1.getCell(0, 124).getContents();
		String Queries_Replied = r1.getCell(0, 125).getContents();
		String Projects_Under_Review = r1.getCell(0, 126).getContents();
		String Projects_with_Queries = r1.getCell(0, 127).getContents();
		String Disposed_Projects = r1.getCell(0, 128).getContents();
