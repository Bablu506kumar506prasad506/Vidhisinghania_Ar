...
public class TS_189 {
	...
	// Check for submission form for approved projects
	...
	public void CRe4_2294_S() throws Exception {
		...
		WebElement save_button2 = GWait.Wait_GetElementById("sumsave");
		save_button2.click();

		GlobalMethods.alertaccept();
		
		String sae_site_type_1 = r1.getCell(2, 29).getContents();
		String sae_report_type_1 = r1.getCell(3, 29).getContents();
		String sae_number_1 = r1.getCell(4, 29).getContents();
		String sae_patient_initial_1 = r1.getCell(5, 29).getContents();
		String Document_Title_in_list = r1.getCell(6, 29).getContents();
		String Version_in_list1 = r1.getCell(7, 29).getContents();
		String Document_Date_in_list = r1.getCell(8, 29).getContents();
		String doc_upload1 = r1.getCell(9, 29).getContents();
		...
		for (int i = 1; i <= sae_docvalue.size() - 1; i++) {
			WebElement sae_docdrop = GWait.Wait_GetElementByXpath("//*[@id='document_type_sae']/div/button");
			sae_docdrop.click();
			...
			if (i == j) {
				...
				doc_version.sendKeys(Version_in_list1);
				...
				upload_doc.sendKeys(doc_upload1);
	...
	public void CRe4_2309_S() throws Exception {
		...
		GlobalMethods.alertaccept();
		Thread.sleep(2000);
		WebElement LogOut11 = GWait.Wait_GetElementByXpath("//span/a");
		LogOut11.click();
		...
		WebElement Sae_dashboard111 = GWait.Wait_GetElementByXpath("//li[8]/a/span");
		Sae_dashboard111.click();
		...
		LogOut6.click();
		GlobalMethods.Screenshot("Test1.0");
		WebElement logo141 = GWait.Wait_GetElementByCSS("img");
		logo141.click();

		GlobalMethods.MS_Login();

		WebElement Sae_dashboard12 = GWait.Wait_GetElementByXpath("//li[8]/a/span");
		Sae_dashboard12.click();
		Thread.sleep(2000);
	...
	public void CRe4_2333_2334_2335_S() throws Exception {
