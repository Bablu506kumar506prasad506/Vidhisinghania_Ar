...
/*
 * Check for 'IEC Submisisons / Annexure' section feature functionality in Chairperson dashboard
 */
public class TS_124 {
	public TS_124() {
	...
	// Check for 'IEC Submissions / Annexures' on dashboard
		public void CRe4_562_564() throws Exception {
			...
			String Project_Type = r1.getCell(2, 234).getContents();
			String Review_Type = r1.getCell(3, 234).getContents();
			String sub_initial = r1.getCell(4, 234).getContents();
			String document_type = r1.getCell(5, 234).getContents();
			String document_upload = r1.getCell(6, 234).getContents();
			...
			WebElement dashboard_annexure = GWait.Wait_GetElementByXpath("//div[7]/div/ul/li/a/span");
			dashboard_annexure.click();
			Thread.sleep(2000);
			...
			WebElement iecannexures = GWait.Wait_GetElementByLinkText("IEC Annexures");
			iecannexures.click();
			Thread.sleep(4000);
