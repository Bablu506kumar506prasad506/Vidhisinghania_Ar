...
//Check for sae initial 'Document status' until MS decision in PI
public class TS_87 {
	...
	public void CRe4_1672_75_77_79() throws Exception {
		...
		Global_Project_Submissions g7=new Global_Project_Submissions();
		g7.PI_SubmitProject_IECAdmin();
		g7.After_PI_Submits_IEC_Statusin_PI();
		g7.Dashboard_Click_Admin();
		g7.InitialSubmission_StatusinAdmin_Starting();
		g7.Admin_Forwardto_MS();
		g7.InitialSubmission_StatusinAdmin_Ending();
		g7.InitialSub_After__IEC_forwardto_MS_StatusInPI();
		g7.MS_Dashboard_Click();
		g7.InitialSubmission_StatusinMS_Starting();
		g7.MS_ForwardTo_CP();
		g7.InitialSubmission_StatusinMS_Ending();
		g7.InitialSub_After__MS_forwardto_CP_StatusInPI();
		g7.CP_DashboardClick();
		g7.InitialSubmission_StatusinCP_Starting();
		g7.CP_SubmitProjectTo_MS();
		g7.InitialSubmission_StatusinCP_Ending();
		g7.InitialSub_After__CP_Submitto_MS_StatusInPI();
		g7.StatusIn_MS_After_CPSubmitsToMS();
		...
		String Document_Title_in_list = r1.getCell(7, 233).getContents();
		String Version_in_list = r1.getCell(8, 233).getContents();
		String Document_Date_in_list = r1.getCell(9, 233).getContents();
		String doc_upload = r1.getCell(10, 233).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(26, 233).getContents();
		String Decisionfile = r1.getCell(27, 233).getContents();
		String Decisioncmnt = r1.getCell(28, 233).getContents();
		

		// SAE submission data

		String sae_site_type_1 = r1.getCell(31, 233).getContents();

		String sae_report_type_1 = r1.getCell(32, 233).getContents();

		String sae_number_1 = r1.getCell(33, 233).getContents();

		String sae_patient_initial_1 = r1.getCell(34, 233).getContents();
		...
		g7.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Submitted to IEC");
		GlobalMethods.Admin_Login();
		g7.Global_Dashboard_SAE();
		g7.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Submitted to IEC");
		g7.SubsequentSubmissions_IECAdmin_forwardto_MS();
		g7.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","MS Review");
		...
		g7.Global_PILoginstatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Under IEC Review");
		GlobalMethods.MS_Login();
		g7.Global_Dashboard_SAE();
		g7.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","MS Review");
		g7.MS_ForwardTo_CP();
		g7.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Forwarded to Chairperson");
		...
		ProjectsLink.click();
		g7.Global_OtherLoginStatus_Verify("Pushpa Project_1213_to_1220","Approved","SAE","Chairperson Review");
