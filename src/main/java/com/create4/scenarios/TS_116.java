...
/*
 * Check for 'Ongoing projects' section feature functionality in Member Secretary dashboard
 */
public class TS_116 {
	...
	public void CRe4_487_to_505() throws Exception{
		...
		String Approved = r1.getCell(2, 23).getContents();
		String Project_Continuous_Request = r1.getCell(3, 23).getContents();
		String Project_Completion_Request = r1.getCell(4, 23).getContents();
		String Queries_Replied = r1.getCell(5, 23).getContents();
		String Projects_Termination = r1.getCell(6, 23).getContents();
		String Amendments = r1.getCell(7, 23).getContents();
		String Deviations = r1.getCell(8, 23).getContents();
		String SAE = r1.getCell(9, 23).getContents();
		String Other_Submissions = r1.getCell(10, 23).getContents();
		...
		// --TAKE COUNT BEFORE FROM "PROJECT CONTINOUS"--//
				...
				WebElement countbefore6 = GWait.Wait_GetElementByXpath("//div[2]/div/div/ul/li[6]/a/span[2]");
				...
				ns.ADMINFRWDPROJDEVMS();

				GlobalMethods.MS_Login();

				// --TAKE COUNT AFTER FROM "DEVIATION"--//
				WebElement countafter6 = GWait.Wait_GetElementByXpath("//div[2]/div/div/ul/li[6]/a/span[2]");
