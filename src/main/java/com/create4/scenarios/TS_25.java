...
*/
		...
		if (LName_Alert.getText().equalsIgnoreCase("Last Name field is required!")) {
			System.out.println(LName_Alert.getText().equalsIgnoreCase("Last Name field is required!"));
		} else {
			System.out.println("Test Fail Alert In Last Name");
		}

		/*
		 * try { if(LName_Alert.isDisplayed()) {
		 * System.out.println(LName_Alert.getText());
		 * System.out.println("Test pass Alert In Last Name"); } else {
		 * System.out.println("Test Fail Alert In Last Name"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 */

		// ---Alert In Email---//

		if (Email_Alert.getText().equalsIgnoreCase("Email field is required!")) {
			System.out.println(Email_Alert.getText().equalsIgnoreCase("Email field is required!"));
		} else {
			System.out.println("Test Fail Alert In Email");
		}

		/*
		 * try { if(Email_Alert.isDisplayed()) {
		 * System.out.println(Email_Alert.getText());
		 * System.out.println("Test pass Alert In Email"); } else {
		 * System.out.println("Test Fail Alert In Email"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 */

		// ---Alert In Middle Name---//

		if (MiddleName_Alert.getText().equalsIgnoreCase("Middle Name field is required!")) {
			System.out.println(MiddleName_Alert.getText().equalsIgnoreCase("Middle Name field is required!"));
		} else {
			System.out.println("Test Fail Alert In Middle Name");
		}
		/*
		 * try { if(MiddleName_Alert.isDisplayed()) {
		 * System.out.println(MiddleName_Alert.getText());
		 * System.out.println("Test pass Alert In Middle Name"); } else {
		 * System.out.println("Test Fail Alert In Middle Name"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 */

		// ---Alert In Employee / Student ID Number---//

		if (EmpID_Alert.getText().equalsIgnoreCase("Employee / Student ID Number field is required!")) {
			System.out
					.println(EmpID_Alert.getText().equalsIgnoreCase("Employee / Student ID Number field is required!"));
		} else {
			System.out.println("Test Fail Alert In Employee / Student ID Number");
		}

		/*
		 * try { if(EmpID_Alert.isDisplayed()) {
		 * System.out.println(EmpID_Alert.getText());
		 * System.out.println("Test pass Alert In Employee / Student ID Number"
		 * ); } else {
		 * System.out.println("Test Fail Alert In Employee / Student ID Number"
		 * ); } } catch (NoAlertPresentException e) { e.getMessage(); }
		 */

		// ---Alert In Date of Birth---//

		if (DOB_Alert.getText().equalsIgnoreCase("Date of birth field is required!")) {
			System.out.println(DOB_Alert.getText().equalsIgnoreCase("Date of birth field is required!"));
		} else {
			System.out.println("Test Fail Alert In Date of Birth");
		}

		/*
		 * try { if(DOB_Alert.isDisplayed()) {
		 * System.out.println(DOB_Alert.getText());
		 * System.out.println("Test pass Alert In Date of Birth"); } else {
		 * System.out.println("Test Fail Alert In Date of Birth"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 */
		...
		/*
		 * try { if(PhoneNumber_Alert.isDisplayed()) {
		 * System.out.println(PhoneNumber_Alert.getText());
		 * System.out.println("Test pass Alert In Phone Number"); } else {
		 * System.out.println("Test Fail Alert In Phone Number"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 */
		...
		/*
		 * try { if(Photo_Alert.isDisplayed()) {
		 * System.out.println(Photo_Alert.getText());
		 * System.out.println("Test pass Alert In Photo"); } else {
		 * System.out.println("Test Fail Alert In Photo"); } } catch
		 * (NoAlertPresentException e) { e.getMessage(); }
		 * 
		 * 
		 */
