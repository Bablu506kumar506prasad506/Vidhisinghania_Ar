...
public class TS_01A {
	...
	public void CRe4_771_772() throws Exception{
			...
			Assert.assertEquals(Inst_Title.getAttribute("value"),Institute_TitleEdit);
			Assert.assertEquals(Adds.getAttribute("value"),AddressEdit);
			Assert.assertEquals(DCGI_Reg_Numr.getAttribute("value"),DCGI_Registration_NumberEdit);
			Assert.assertEquals(st1[1],DCGIRegUploadEdit);
			Assert.assertEquals(Accredn.getAttribute("value"),AccreditationEdit);
		...
		public void CRe4_773() throws Exception{
			...
			Thread.sleep(3000);
			Inst_Title.clear();
			Inst_Title.sendKeys(InstituteTitleEdit);
			
			Thread.sleep(3000);
			Adds.clear();
			Adds.sendKeys(InstituteAddrssEdit);
			
			Thread.sleep(3000);
			DCGI_Reg_Numr.clear();
			DCGI_Reg_Numr.sendKeys(InstituteRegEdit);
						
			Thread.sleep(3000);
			Accredn.clear();
			Accredn.sendKeys(InstituteAcredationEdit);
