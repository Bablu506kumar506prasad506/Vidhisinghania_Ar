...
//Check for�continutinuing submission flow with valid/invalid data
public class TS_159 {
	...
	// Check for continuation submission form for approved projects
	public void CRe4_2201() throws Exception {

		
	}

	// Check for continuation form mandatory fields
	...
	// Check for submit new document document list section in continuation
	...
	// Check for save continuation as draft
	...
	// Check for continuation in admin login
	public void CRe4_2213() throws Exception {
		...
		try {
			...
			WebElement continuation_dashboard = GWait.Wait_GetElementByXpath("//div[2]/div/div/ul/li[2]/a/span");
			continuation_dashboard.click();
	...
	// Check for MS assign reviewers if continuation is of expedited review type
	public void CRe4_CRe4_2214_2215_2216() throws Exception {
		...
		gps.Global_Dashboard_ContinuationLink();
	...
	// Check for document type field in continuation form
