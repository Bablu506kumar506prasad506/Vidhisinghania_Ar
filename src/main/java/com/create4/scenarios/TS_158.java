...
//Check for�deviation submission flow with valid/invalid data
public class TS_158 {
	...
	// Check for deviation submission form for approved projects
	public void CRe4_2253() throws Exception {


	}

	// Check for deviation form mandatory fields
	public void CRe4_2154_2163_2164() throws Exception {
		...
		String Version_in_list = r1.getCell(2, 17).getContents();
		String doc_upload = r1.getCell(3, 17).getContents();

		String docutypetitle = r1.getCell(4, 17).getContents();
		String docutypedate = r1.getCell(5, 17).getContents();
	...
	// Check for deviation in admin login
	public void CRe4_2165() throws Exception {
		...
		try {
			...
			String submission_name_in_adminlist = Amendment_Data.getCell(2, 19).getContents();
	...
	// Check for MS assign reviewers if deviation is of expedited review type
	public void CRe4_2166_2167_2168() throws Exception {
		...
		String Document_Title_in_list = r1.getCell(2, 21).getContents();
		String Version_in_list = r1.getCell(3, 21).getContents();
		String Document_Date_in_list = r1.getCell(4, 21).getContents();
		String doc_upload = r1.getCell(5, 21).getContents();
		...
		String pyrcnum = r1.getCell(6, 21).getContents();
		String inwnum = r1.getCell(7, 21).getContents();
		String prjnum = r1.getCell(8, 21).getContents();
		String insdate = r1.getCell(9, 21).getContents();
		String inwrddate = r1.getCell(10, 21).getContents();
		String ethic_com = r1.getCell(11, 21).getContents();
		String ethic_comnts = r1.getCell(12, 21).getContents();
		...
		String Rev_one = r1.getCell(13, 21).getContents();

		String Decision_LOP = r1.getCell(14, 21).getContents();
		String Decisionfile = r1.getCell(15, 21).getContents();
		String Decisioncmnt = r1.getCell(16, 21).getContents();
		...
		gps.Global_Dashboard_DeviationLink();
		...
		Thread.sleep(6000);
		GWait.blockUI();
		WebElement LogOut6 = GWait.Wait_GetElementByXpath("//span[3]/a");
		LogOut6.click();
	...
	// Check for MS assign reviewers if continuation is of full board review
	// type
	public void CRe4_2169() throws Exception {
		...
		// Create initial project and give MS decision as 'Letter of permission'
				...
				String Review_Type = r1.getCell(2, 23).getContents();
				String Review_Type_expedited = r1.getCell(3, 23).getContents();
				String Document_Title_in_list = r1.getCell(4, 23).getContents();
				String Version_in_list = r1.getCell(5, 23).getContents();
				String Document_Date_in_list = r1.getCell(6, 23).getContents();
				String doc_upload = r1.getCell(7, 23).getContents();

				String ethic_com = r1.getCell(8, 23).getContents();
				String ethic_comnts = r1.getCell(9, 23).getContents();

				String Rev_one = r1.getCell(10, 23).getContents();
	...
	// Check for document type field in deviation form
	public void CRe4_2155_2156_2157() throws Exception {
		...
		String document_types = r1.getCell(2, 25).getContents();

		String Project_Type = r1.getCell(3, 25).getContents();
		String Review_Type = r1.getCell(4, 25).getContents();
		
		String document_upload = r1.getCell(5, 25).getContents();
		String sub_amend = r1.getCell(6, 25).getContents();
		...
		WebElement proj = GWait.Wait_GetElementByXpath("html/body/div[3]/div/div[2]/ul/li[2]/a");
		proj.click();
		GlobalMethods.Screenshot("test1");
		GWait.blockUI();
		WebElement LogOut = GWait.Wait_GetElementByXpath("//span[3]/a");
		LogOut.click();
		GlobalMethods.Screenshot("test2");
		WebElement logo = GWait.Wait_GetElementByCSS("img");
		logo.click();
	...
	// Check for submit new document document list section in deviation
	public void CRe4_2158_2159_2260_2161() throws Exception {
		...
		String Document_Title_in_list = r1.getCell(2, 27).getContents();
		String Version_in_list = r1.getCell(3, 27).getContents();
		String Document_Date_in_list = r1.getCell(4, 27).getContents();
		String doc_upload = r1.getCell(5, 27).getContents();
		String amend_doc_title = r1.getCell(6, 27).getContents();
		String amend_doc_version = r1.getCell(7, 27).getContents();
		String amend_doc_date = r1.getCell(8, 27).getContents();

		String amend_doc_title_edit = r1.getCell(9, 27).getContents();
		String amend_doc_version_edit = r1.getCell(10, 27).getContents();
		String amend_doc_date_edit = r1.getCell(11, 27).getContents();
		String amend_doc_upload_edit = r1.getCell(12, 27).getContents();
		...
		WebElement edit_doc_date = GWait.Wait_GetElementById("document_date_edit");
		edit_doc_date.clear();
		...
		Thread.sleep(2000);
		String amend_document_title_2 = amend_document_title.getText();
	...
	// Check for single member comment on continuation before MS comments
