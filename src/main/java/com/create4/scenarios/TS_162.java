...
//Check project flow for initial submision for MS decisions
...
public class TS_162 {
	...
	WebElement query_replied_dashboard;
	...
	// Check project flow for initial submission when decision as 'Letter of permission'
	public void CRe4_1225() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,475).getContents();
		String Decisionfile = r1.getCell(3,475).getContents();
		String Decisioncmnt = r1.getCell(4,475).getContents();
	...
	//*****************Check for the Overview and submit new projects option after ms decision***********// 
	...
	// Check project flow for initial submission when decision as 'Provisional Letter of Permission'
	public void CRe4_1235() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,477).getContents();
		String Decisionfile = r1.getCell(3,477).getContents();
		String Decisioncmnt = r1.getCell(4,477).getContents();
	...
	// Check project flow for initial submission when decision as 'Resubmission Letter'
	public void CRe4_1240() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,479).getContents();
		String Decisionfile = r1.getCell(3,479).getContents();
		String Decisioncmnt = r1.getCell(4,479).getContents();
	...
	// Check project flow for initial submission when decision as 'Query Letter– MS'
	public void CRe4_1245() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,481).getContents();
		String Decisionfile = r1.getCell(3,481).getContents();
		String Decisioncmnt = r1.getCell(4,481).getContents();
	...
	// Check project flow for initial submission when decision as 'Query Letter – Full Board'
	public void CRe4_1250() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,483).getContents();
		String Decisionfile = r1.getCell(3,483).getContents();
		String Decisioncmnt = r1.getCell(4,483).getContents();
	...
	// Check project flow for initial submission when decision as 'Query Letter – Reviewers'
	public void CRe4_1255() throws Exception {
		...
		String Decision_LOP = r1.getCell(2,485).getContents();
		String Decisionfile = r1.getCell(3,485).getContents();
		String Decisioncmnt = r1.getCell(4,485).getContents();
