...
//Check for�amendment submission flow with valid/invalid data
public class TS_157 {
	...
	// ---------------Check for submit new documents------------------------//
	public void CRe4_2105() throws Exception {

		// This method is covered in subsequent project submissions

	}

	// Check for amendment submission form for approved projects
	public void CRe4_2107() throws Exception {

		// This method is covered in subsequent project submissions
	}

	// Check for amendment form mandatory fields
	public void CRe4_2108() throws Exception {
		...
		for (int i = 1; i <= docvalue1.size() - 10; ) {
			Thread.sleep(3000);
			GWait.LoadGif();
			docdrop1.click();
	...
	// Check for submit new document document list section in amendment
	...
	// Check for save amendment as draft
	...
	// Check for amendment in admin login
	public void CRe4_2119() throws Exception {
		...
		try {
			...
			WebElement amend_dashboard = GWait.Wait_GetElementByXpath("//div[2]/div/div/ul/li[6]/a/span");
			amend_dashboard.click();
	...
	// Check for MS assign reviewers if amendment is of expedited review type
	public void CRe4_2120_2121_2122() throws Exception {
		...
		gps.Global_Dashboard_AmendmentLink();
		...
		System.out.println(assign_reviewers_alert);
	...
	// Check for MS assign reviewers if amendment is of full board review type
	public void CRe4_2123() throws Exception {
		...
		assign_button.click();
		Thread.sleep(4000);
		WebElement LogOut61 = GWait.Wait_GetElementByXpath("//span[3]/a");
		LogOut61.click();

	}

	// Check for document type field in amendment form
	public void CRe4_2109_2110_2111() throws Exception {
		...
		Thread.sleep(3000);
		WebElement Pro = GWait.Wait_GetElementByXpath("html/body/div[3]/div/div[2]/ul/li[2]/a");
		Pro.click();
		Thread.sleep(3500);
		WebElement LogOut = GWait.Wait_GetElementByXpath("//span[3]/a");
		LogOut.click();
	...
	// Check for single member comment on amendment before MS comments
