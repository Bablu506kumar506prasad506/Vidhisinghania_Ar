...
//Check for sae initial submission project status for all MS decisions
public class TS_57 {
	...
	// Check for 'Project status' when SAE Initial submission gets MS decision as 'Query Letter'
	...
	public void CRe4_1680() throws Exception {
		...
		String Document_Title_in_list = r1.getCell(7,99).getContents();
		String Version_in_list = r1.getCell(8,99).getContents();
		String Document_Date_in_list = r1.getCell(9,99).getContents();
		String doc_upload = r1.getCell(10,99).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,99).getContents();
		String Decisionfile = r1.getCell(32,99).getContents();
		String Decisioncmnt = r1.getCell(33,99).getContents();


		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,99).getContents();

		String sae_report_type_1 = r1.getCell(14,99).getContents();

		String sae_number_1 = r1.getCell(15,99).getContents();

		String sae_patient_initial_1 = r1.getCell(16,99).getContents();
		...
		WebElement logo134 = GWait.Wait_GetElementByCSS("img");
		logo134.click();
		...
		String Decision_LOP1 = r11.getCell(31,99).getContents();
		String Decisionfile1 = r11.getCell(32,99).getContents();
		String Decisioncmnt1 = r11.getCell(33,99).getContents();
	...
	// Check for 'Project status' when SAE Initial submission gets MS decision as 'Noted Letter'
	public void CRe4_1733() throws Exception {
		...
		// Document upload data
		String Document_Title_in_list = r1.getCell(7,101).getContents();
		String Version_in_list = r1.getCell(8,101).getContents();
		String Document_Date_in_list = r1.getCell(9,101).getContents();
		String doc_upload = r1.getCell(10,101).getContents();

		// Decision upload data
		String Decision_LOP = r1.getCell(11,101).getContents();
		String Decisionfile = r1.getCell(32,101).getContents();
		String Decisioncmnt = r1.getCell(33,101).getContents();


		// SAE submission data

		String sae_site_type_1 = r1.getCell(13,101).getContents();

		String sae_report_type_1 = r1.getCell(14,101).getContents();

		String sae_number_1 = r1.getCell(15,101).getContents();

		String sae_patient_initial_1 = r1.getCell(16,101).getContents();
		...
		String Decision_LOP1 = r11.getCell(31,101).getContents();
		String Decisionfile1 = r11.getCell(32,101).getContents();
		String Decisioncmnt1 = r11.getCell(33,101).getContents();
