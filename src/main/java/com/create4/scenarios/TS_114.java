...
/*
 * Check for 'Announcement' section feature functionality in Admin dashboard
 */
public class TS_114 {
	public TS_114() {
		// this.driver=driver;
	...
	@FindBy(xpath = "html/body/div[4]/div/div/div[2]/div[10]/div/h3")
	WebElement AnnouncementsTXT;
	@FindBy(xpath = "//div[2]/div[10]/div/ul/li[1]/a/span")
	WebElement GetList1;
	@FindBy(xpath = "//div[2]/div[10]/div/ul/li[2]/a/span")
	WebElement GetList2;
	@FindBy(xpath = "//div[2]/div[10]/div/ul/li[3]/a/span")
	WebElement GetList3;
	@FindBy(xpath = "//div[2]/div[10]/div/ul/li[4]/a/span")
	WebElement GetList4;
	@FindBy(xpath = "//div[2]/div[10]/div/ul/li[5]/a/span")
	WebElement GetList5;
	...
	public void CRe4_468_469_470_471_472() throws Exception {
		...
		String announce_title = r1.getCell(2, 17).getContents();
		String announce_desc = r1.getCell(3, 17).getContents();
		String announce_file = r1.getCell(4, 17).getContents();
		String announce_date = r1.getCell(5, 17).getContents();
		String announce_acknowledge = r1.getCell(6, 17).getContents();
