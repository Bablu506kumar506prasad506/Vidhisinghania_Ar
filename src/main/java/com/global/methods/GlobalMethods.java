...
public class GlobalMethods {
	...
	public static void Admin_Login() throws Exception {
		...
		WebElement Register_Email = GWait.Wait_GetElementById("register_email");
		Register_Email.sendKeys(admin_email);
		driver.findElement(By.id("register_password")).sendKeys(Admin_Password);
		Select dropdown = new Select(driver.findElement(By.id("register_role")));
		dropdown.selectByValue("3");
		driver.findElement(By.id("login_institute")).click();
	...
	public static void MS_Login() throws Exception {
		...
		String MS_Institute = r1.getCell(0, 4).getContents();
	...
	public static void PIMail(String url, String Email, String Password) throws Exception {
		...
		Thread.sleep(10000);
		driver.findElement(
				By.xpath("//span/b[text()='e-EC - Approved: Request to Register as Principal Investigator']")).click();
		Thread.sleep(6000);
	...
	/*
	 * public static void AdminMail_04(String url, String Email, String
	 * Password) throws InterruptedException, BiffException, IOException {
	 * driver.get(url); driver.findElement(By.id("identifierId")).clear();
	 * driver.findElement(By.id("identifierId")).sendKeys(Email);
	 * driver.findElement(By.cssSelector("span.RveJvd.snByac")).click();
	 * Thread.sleep(2000); driver.findElement(By.name("password")).clear();
	 * driver.findElement(By.name("password")).sendKeys(Password);
	 * driver.findElement(By.cssSelector("span.RveJvd.snByac")).click();
	 * Thread.sleep(60000);
	 * driver.findElement(By.cssSelector(".asf.T-I-J3.J-J5-Ji")).click();
	 * Thread.sleep(3000);
	 * driver.findElement(By.cssSelector(".asf.T-I-J3.J-J5-Ji")).click();
	 * System.out.println("Refresh button Clicked"); Thread.sleep(20000);
	 * System.out.println("Refresh button Clicked"); Thread.sleep(10000);
	 * driver.findElement(By.xpath(
	 * "//span/b[text()='e-EC - You have been Registered as IEC Admin by e-EC']"
	 * )).click(); Thread.sleep(10000); driver.findElement(By.xpath(
	 * "//div[starts-with(@class,'a3s aXjCH m1')]/a")).click();
	 ...
	 * driver.findElement(By.name("activation_password")).sendKeys("123456admin"
	 * ); String
	 * Password1=driver.findElement(By.name("activation_password")).getAttribute
	 * ("Value"); Thread.sleep(2000);
	 * driver.findElement(By.id("activation_update_id")).click();
	 * Thread.sleep(6000); //System.out.println(forgotspwdmsg.getText());
	 * Thread.sleep(2000);
	 * 
	 * String winHandleBefore1 = ""; driver.switchTo().window(winHandleBefore1);
	 * 
	 * 
	 * FileInputStream fi = new
	 * FileInputStream("C:\\Selenium_Files\\Create4_v2\\CReATE4_Data.xls");
	 * Workbook wb = Workbook.getWorkbook(fi); Sheet r1 =
	 * wb.getSheet("Institute");
	 * 
	 * String Admin_Institute = r1.getCell(0, 3).getContents(); String
	 * Adminemail = r1.getCell(1, 3).getContents(); String Admin_Password =
	 * r1.getCell(2, 3).getContents(); String Admin_Role = r1.getCell(3,
	 * 3).getContents(); Thread.sleep(4000);
	 * 
	 * logo.click();
	 * 
	 * 
	...
	public static void MS_MemMail(String url, String Email, String Password) throws Exception {
		...
		System.out.println("Refresh button Clicked");
		Thread.sleep(20000);
		driver.findElement(By.xpath("//span/b[text()='e-EC - You have been Registered as IEC Member by IEC Admin']"))
				.click();
		Thread.sleep(6000);
		driver.findElement(By.xpath("//div[starts-with(@class,'a3s aXjCH m1')]/a")).click();
		Thread.sleep(6000);
		...
		/*
		 * driver.findElement(By.xpath(
		 * "//form[@id='activation_user_form']/div/div[2]/div/input")).sendKeys(
		 * "123456admin"); String Password1=driver.findElement(By.xpath(
		 * "//div[starts-with(@class,'a3s aXjCH m15f')]/a"
		 * )).getAttribute("Value"); Thread.sleep(2000);
		 * driver.findElement(By.id("savedoc")).click();
		 */
		String winHandleBefore1 = "";
		driver.switchTo().window(winHandleBefore1);
	...
	public static void remeetingMail(String url, String Email, String Password) throws InterruptedException {
		...
		System.out.println("Refresh button Clicked");
		Thread.sleep(20000);
		driver.findElement(By.xpath("//span/b[text()='e-EC - Update in Invitation for the Upcoming IEC Meeting']"))
				.click();
		Thread.sleep(6000);
		Thread.sleep(2000);
	...
	public static void ContactUS(String url, String Email, String Password) throws InterruptedException {
		...
		Thread.sleep(20000);
		Thread.sleep(6000);
		driver.findElement(By.xpath("//span/b[text()='e-EC - Request Received']")).click();
		Thread.sleep(10000);
		WebElement icon_Click = GWait.Wait_GetElementByCSS(".gb_db.gbii");
		icon_Click.click();
		Thread.sleep(2000);
		WebElement LogOut_Click = GWait.Wait_GetElementByXpath("//div[1]/div[2]/div[5]/div[2]/div[4]/div[2]/a");
		LogOut_Click.click();

	}

	public static void feedback(String url, String Email, String Password) throws InterruptedException {
		...
		Thread.sleep(20000);
		Thread.sleep(6000);
		driver.findElement(By.xpath("//span/b[text()='e-EC - Feedback Acknowledgement']")).click();
		Thread.sleep(10000);
		WebElement icon_Click = GWait.Wait_GetElementByCSS(".gb_db.gbii");
		icon_Click.click();
		Thread.sleep(2000);
